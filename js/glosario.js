        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>El método del índice de rentabilidad o también conocido como razón de beneficio/costo permitirá calcular la ganancia o 
                  ...
                  (K), y la inversión inicial requerida </em>. (Alemán, 2003)</p>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>“Es el empleo de un conjunto de recursos para producir un bien o servicio y generar una utilidad” </em>.
                  (Sabino, 2015, citado en Angulo, 2016, p. 18).</p>
                <br>
                <p><em>La inversión implica “emplear recursos hoy: se renuncia al uso inmediato de un recurso disponible con la esperanza de 
                  ...
                  uno futuro”</em>. (Angulo, 2016, p. 18).
                </p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em> Los métodos para evaluar proyectos de inversión son una herramienta financiera que permiten determinar la rentabilidad 
                  ...
                  el tiempo y los que no lo toman en cuenta</em>.</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>Método de evaluación de proyectos que permite estimar el tiempo (en años, meses y días) que se requieren para recuperar 
                  ...
                  la inversión inicial </em>. (Alemán, 2003).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>El presupuesto de inversión es una estimación en términos monetarios de lo que se necesita para arrancar un proyecto. 
                  Dicho presupuesto se compone de tres partes</em>. (Nacional Financiera, 1998; Angulo, 2016):</p>
                  <br>
                  <ol type="a">
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>El proceso de preparación y evaluación de proyectos incluye los siguientes estudios: de mercado, técnico, administrativo 
                  o de organización y financiero </em>. (Baca, 2016; Sapag, 2007; Angulo, 2016).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>“Proyecto es un esfuerzo temporal que se lleva a cabo para obtener un producto, servicio o resultado único”</em>.
                  ...
                  mencionar algunos.</p>
                <br>
                <p><em>“Un proyecto es la búsqueda de una solución inteligente al planteamiento de un problema, la cual tiende a resolver una 
                  necesidad humana”</em>. (Baca, 2016, p. 2).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>“Es un plan que, si se le asigna determinado monto de capital y se le proporcionan insumos de varios tipos, producirá un 
                  bien o servicio, útil para la sociedad” </em>. (Baca, 2016, p. 2).</p>
                <br>
                <p><em>“Una propuesta (un documento con varios planes o estudios) de inversión para instalaciones destinadas a proporcionar 
                  bienes o servicios"</em>. (Angulo, 2016, p. 19).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>Método de evaluación de proyectos que permite calcular la razón que existe entre los flujos netos de efectivo promedio 
                  del proyecto y la inversión inicial requerida; es decir: </em>.</p>
                  <br>
                  <div align="center"><img src="./assets/RAP.PNG" alt=""></div>
                  <br>
                <p><b>Criterios de decisión:</b></p>
                <br>
                <p><em>Si el cálculo del rendimiento anual promedio es igual o mayor a la tasa de rendimiento anual mínima establecida por el 
                  inversionista el proyecto podría aceptarse, de lo contrario se rechazaría </em>. (Alemán, 2003)</p>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>El método de la TIR está estrechamente relacionado con el método del VPN, ya que es la tasa de descuento que hace que 
                  ...
                  interna ya que depende solamente de los flujos de efectivo que genera el proyecto</em>. (Baca, 2017; Angulo, 2016; Alemán, 2003).</p>
                <br>
                <p>Su fórmula es:</p>
                <br>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>Método que toma en cuenta el valor del dinero en el tiempo. Se define como el valor de los flujos netos de efectivo 
                  ...
                  </em>. (Baca, 2017; Angulo, 2016; Alemán, 2003).</p>
                  <br>
                  <p align="center"><b>Criterios de decisión</b></p>
                  <br>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p><em>“La vida útil de un proyecto se asocia con el tiempo durante el cual se espera recibir beneficios o con el plazo 
                  en el que se estima subsistirán los problemas que se busca resolver. La vida útil no debe confundirse con el horizonte de 
                  evaluación, aunque pueden coincidir” </em>. (Angulo, 2016, p. 295).</p>
              </div>
            </div>
          </div>`
        },
