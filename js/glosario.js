$(document).ready(function(){      
    ...
    const elementos=[
        ...
        <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box col-xl-12 col-md-12">
            <div class="icon"><i class="bi bi-calendar4-range"></i></div>
            <h4><a href="">Horizonte de evaluación de un proyecto</a></h4>
            <p>“Es el período durante el cual se pronosticarán los flujos de caja para medir la rentabilidad de un proyecto”. La vida útil de un proyecto no debe confundirse con el horizonte de evaluación, aunque pueden coincidir (Angulo, 2016, p. 295).</p>
          </div>
        </div>
      </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Índice de rentabilidad (IR) o razón de beneficio/costo</a></h4>
                <p>El método del índice de rentabilidad o también conocido como razón de beneficio/costo permitirá calcular la ganancia o 
                  pérdida neta que tiene una inversión durante el tiempo de vida del proyecto, el resultado se expresa como un porcentaje del 
                  costo inicial de la inversión. Las ganancias o beneficios de la inversión se pueden definir como la razón que hay entre la 
                  suma de los valores presentes de los flujos netos de efectivo (FNE) de un proyecto, descontados con la tasa de costo de capital 
                  (K), y la inversión inicial requerida . (Alemán, 2003)</p>
                  <br><div align="center"><img src="./assets/Formula_IR.PNG" alt="Formula_IR"></div>
                  <br>
                  <p>El IR se puede interpretar como el valor presente o la rentabilidad que se obtiene por cada unidad monetaria invertida en 
                    el proyecto. </p>
                  <p align="center"><b>Criterios de decisión:</b></p>
                  <br><div align="center"><img src="./assets/CriteriosIR.PNG" alt="Criterios_evaluacion_IR"></div>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <p>“Es el empleo de un conjunto de recursos para producir un bien o servicio y generar una utilidad” .
                  (Sabino, 2015, citado en Angulo, 2016, p. 18).</p>
                <br>
                <p>La inversión implica “emplear recursos hoy: se renuncia al uso inmediato de un recurso disponible con la esperanza de 
                  recuperarlo en un tiempo determinado con una utilidad adicional. En pocas palabras se renuncia a un beneficio inmediato por 
                  uno futuro”. (Angulo, 2016, p. 18).
                </p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h3><a href="">Métodos de evaluación financiera para proyectos de inversión</a></h3>
                <p> Los métodos para evaluar proyectos de inversión son una herramienta financiera que permiten determinar la rentabilidad 
                  económica que generaría el proyecto durante su tiempo de vida. Existen los métodos que toman en cuenta el valor del dinero en 
                  el tiempo y los que no lo toman en cuenta.</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Período de recuperación de la inversión (PRI)</a></h4>
                <p>Método de evaluación de proyectos que permite estimar el tiempo (en años, meses y días) que se requieren para recuperar 
                  la inversión inicial de un proyecto. Únicamente se tiene que sumar los flujos netos de efectivo del proyecto hasta recuperar 
                  la inversión inicial . (Alemán, 2003).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Presupuesto de inversión</a></h4>
                <p>El presupuesto de inversión es una estimación en términos monetarios de lo que se necesita para arrancar un proyecto. 
                  Dicho presupuesto se compone de tres partes. (Nacional Financiera, 1998; Angulo, 2016):</p>
                  <br>
                  <ol type="a">
                    <li><b>Inversión diferida. </b>Se refiere a los desembolsos que se harán por trámites, permisos, gastos notariales y 
                      licencias para la constitución legal de la empresa; desembolsos por pago de renta, compra de artículos de oficina y en sí 
                      de los gastos preoperatorios. Entendiéndose por estos todos aquellos gastos que se realizan antes de que se lleve a cabo 
                      la operación del negocio. </li><br>
                    <li><b>Inversión fija. </b>Corresponde a los desembolsos que se hacen para equipar la empresa (propiedades, planta y equipo). 
                      La cantidad y el tipo de activos fijos que se adquirirán estarán en función del tipo de proyecto y de un plan de producción.
                    </li><br>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Proceso de preparación y evaluación de proyectos </a></h4>
                <p>El proceso de preparación y evaluación de proyectos incluye los siguientes estudios: de mercado, técnico, administrativo 
                  o de organización y financiero . (Baca, 2016; Sapag, 2007; Angulo, 2016).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Proyecto</a></h4>
                <p>“Proyecto es un esfuerzo temporal que se lleva a cabo para obtener un producto, servicio o resultado único”.
                  (Guía del PMBOK, 2017, p. 4). Esta definición es bastante inclusiva podría abarcar, por ejemplo, un proyecto escolar, un 
                  proyecto de vida, la construcción de una vivienda, el lanzamiento de un satélite, así como la creación de una empresa, por 
                  mencionar algunos.</p>
                <br>
                <p>“Un proyecto es la búsqueda de una solución inteligente al planteamiento de un problema, la cual tiende a resolver una 
                  necesidad humana”. (Baca, 2016, p. 2).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Proyecto de inversión</a></h4>
                <p>“Es un plan que, si se le asigna determinado monto de capital y se le proporcionan insumos de varios tipos, producirá un 
                  bien o servicio, útil para la sociedad” . (Baca, 2016, p. 2).</p>
                <br>
                <p>“Una propuesta (un documento con varios planes o estudios) de inversión para instalaciones destinadas a proporcionar 
                  bienes o servicios". (Angulo, 2016, p. 19).</p>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Rendimiento anual promedio (RAP) o tasa contable del rendimiento (TCR)</a></h4>
                <p>Método de evaluación de proyectos que permite calcular la razón que existe entre los flujos netos de efectivo promedio 
                  del proyecto y la inversión inicial requerida; es decir: .</p>
                  <br>
                  <div align="center"><img src="./assets/RAP.PNG" alt=""></div>
                  <br>
                <p><b>Criterios de decisión:</b></p>
                <br>
                <p>Si el cálculo del rendimiento anual promedio es igual o mayor a la tasa de rendimiento anual mínima establecida por el 
                  inversionista el proyecto podría aceptarse, de lo contrario se rechazaría . (Alemán, 2003)</p>
        ...
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Tasa interna de rendimiento (TIR)</a></h4>
                <p>El método de la TIR está estrechamente relacionado con el método del VPN, ya que es la tasa de descuento que hace que 
                  la suma del valor presente de los flujos netos de efectivo generados por un proyecto sea igual a la inversión inicial. 
                  Es decir, es la tasa que induce a que el VPN de un proyecto sea igual a cero. Se dice que la TIR es una tasa de rendimiento 
                  interna ya que depende solamente de los flujos de efectivo que genera el proyecto. (Baca, 2017; Angulo, 2016; Alemán, 2003).</p>
                <br>
                <p>Su fórmula es:</p>
                <br>
                <div align="center"><img src="./assets/TIR.PNG" alt="Formula_TIR"></div>
                <br>
                <p>Dónde:</p>
                <p>TIR = Tasa interna de rendimiento </p>
                <p>VPN = Valor presente neto </p>
                <p>FNE = Flujo neto de efectivo</p>
                <p>Io = Inversión inicial requerida </p>
                <p>n = Número de periodos de vida del proyecto (tiempo de vida) </p>
                <p align="center"><b>Criterios de decisión:</b></p>
                <br>
                <div align="center"><img src="./assets/CriteriosTIR.PNG" alt="Criterios_TIR"></div>
              </div>
            </div>
          </div>
    `
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                <div class="icon"><i class="bi bi-cash-coin"></i></div>
                <h4><a href="">Valor presente neto (VPN) o valor actual neto (VAN)</a></h4>
                <p>Método que toma en cuenta el valor del dinero en el tiempo. Se define como el valor de los flujos netos de efectivo 
                  proyectados descontados al presente menos la inversión inicial. Es un método financiero utilizado para evaluar la rentabilidad 
                  de la inversión inicial de un proyecto. El cálculo depende de la tasa mínima aceptable de rendimiento (TMAR) o también conocida 
                  como costo de capital (K) que se establezca para el proyecto en cuestión. La fórmula para calcular el VPN o VAN es a través de 
                  un quebrado o razón aritmética en donde el numerador de dicha razón es dinero (flujos netos de efectivo descontados al presente) 
                  y el denominador es la tasa de interés a la cual se ajusta el proyecto (TMAR), a este resultado se le restara el valor de la 
                  inversión inicial (Io). 
                  . (Baca, 2017; Angulo, 2016; Alemán, 2003).</p>
                  <br>
                  <p align="center"><b>Criterios de decisión</b></p>
                  <br>
                  <div align="center"><img src="./assets/CriteriosVPN.PNG" alt="CriteriosVPN"></div>
              </div>
            </div>
          </div>`
        },
        {
            ...
            <div class=" d-flex align-items-stretch biblio" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box col-xl-12 col-md-12">
                ...
                <h4><a href="">Vida útil del proyecto</a></h4>
                <p>“La vida útil de un proyecto se asocia con el tiempo durante el cual se espera recibir beneficios o con el plazo 
                  en el que se estima subsistirán los problemas que se busca resolver. La vida útil no debe confundirse con el horizonte de 
                  evaluación, aunque pueden coincidir” . (Angulo, 2016, p. 295).</p>
              </div>
            </div>
          </div>`
        },
    ...
    filtrar();//(es para que aparezcan todos los conceptos al principio)
});